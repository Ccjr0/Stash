...
if !has("gui_running")
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-dark.sh"
  endif
endif
...
call <sid>hi("Underlined",    s:gui0C, "", s:cterm0C, "", "", "")
call <sid>hi("Visual",        "", s:gui02, "", s:cterm02, "", "")
call <sid>hi("VisualNOS",     s:gui08, "", s:cterm08, "", "", "")
call <sid>hi("WarningMsg",    s:gui08, "", s:cterm08, "", "", "")
call <sid>hi("WildMenu",      s:gui08, s:gui0A, s:cterm08, "", "", "")
call <sid>hi("Title",         s:gui0B, "", s:cterm0B, "", "bold", "")
...
" HTML highlighting
call <sid>hi("htmlBold",    s:gui05, "", s:cterm05, "", "bold", "")
call <sid>hi("htmlItalic",  s:gui05, "", s:cterm05, "", "italic", "")
